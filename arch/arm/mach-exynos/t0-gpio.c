...
static struct gpio_init_data m0_init_gpios[] = {
	...
	{EXYNOS4_GPY0(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* FM_RST_REV03 */
#else
...
static unsigned int m0_sleep_gpio_table[][3] = {
	...
	{EXYNOS4_GPL0(3),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},/* VPS EN */
