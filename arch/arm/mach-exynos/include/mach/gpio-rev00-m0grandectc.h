...
#define GPIO_CP_SIM_DETECT		EXYNOS4_GPX3(6)
#define CP_SIM_DETECT_IRQ		IRQ_EINT(30)
#define GPIO_ESC_SIM_DETECT		EXYNOS4_GPX0(1)
#define ESC_SIM_DETECT_IRQ		IRQ_EINT(1)
#endif
